...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if efficency >= 80:
        return 'green'
    elif 60 <= efficency < 80:
        return 'orange'
    elif 30 <= efficency < 60:
        return 'red'
    elif efficency < 30:
        return 'black'
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temperature * neutrons_produced_per_second < (threshold * 0.90):
        return 'LOW'
    elif temperature * neutrons_produced_per_second >= (threshold * 0.90) and temperature * neutrons_produced_per_second <= (threshold * 1.10):
        return 'NORMAL'
    else:
        return 'DANGER'
