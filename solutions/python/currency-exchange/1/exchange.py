...
def exchange_money(budget, exchange_rate):
    ...
    received_value = budget / exchange_rate
...
def get_value_of_bills(denomination, number_of_bills):
    ...
    """
    total_bill_value = denomination * number_of_bills
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    value = budget / actual_exchange_rate
    maximum_value = (value // denomination) * denomination
