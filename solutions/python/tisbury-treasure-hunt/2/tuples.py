...
def convert_coordinate(coordinate):
    ...
    """
    string_coordinate = tuple(coordinate)
    return string_coordinate
...
def compare_records(azara_record, rui_record):
    ...
    """
    coord1 = azara_record[1]
    coord2tup = rui_record[1]
    coord2 = coord2tup[0] + coord2tup[1]
    if coord1 == coord2:
        return True
    return False
...
def create_record(azara_record, rui_record):
    ...
    coord2 = coord2tup[0] + coord2tup[1]
    if coord1 == coord2:
        combinedrecord = azara_record + rui_record
...
def clean_up(combined_record_group):
    ...
    """
    records = []
    for recorde in combined_record_group:
        temp_list = list(recorde)
        temp_list.pop(1)
        tumplegood = tuple(temp_list)
        records.append(tumplegood)
